...
**After the release of [v1.8.1], OpenPAI entered stable mode and the repos changed to read only mode. Many users are concerned with the future of the project. Here we announce that OpenXPU will continue the development and support.**
